...
import {
  ...
  Flag, Megaphone, Building2, BookOpen, Settings, X, GraduationCap, ChevronRight
} from 'lucide-react';
...
const links = [
  ...
  { label: 'Teacher Verifications', href: '/admin/teacher-verifications', icon: ShieldCheck,   badge: '3'  },
  { label: 'Content Approvals',   href: '/admin/content-approvals',    icon: CheckSquare,     badge: '8'  },
  { label: 'Reports',             href: '/admin/reports',              icon: Flag,            badge: '2'  },
  { label: 'Announcements',       href: '/admin/announcements',        icon: Megaphone,       badge: null },
  { label: 'Departments',         href: '/admin/departments',          icon: Building2,       badge: null },
  { label: 'Subjects',            href: '/admin/subjects',             icon: BookOpen,        badge: null },
      ...
      <aside className={cn(
        ...
        <div className="px-4 py-3 border-b border-sidebar-border">
          <div className="flex items-center gap-2 bg-orange-500/10 rounded-lg px-3 py-2">
            ...
            <span className="text-xs font-semibold text-orange-400 uppercase tracking-wide">Admin Portal</span>
          </div>
        </div>
